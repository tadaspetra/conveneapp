...
///- will only return a singleton instance
...
class ConfigReader {
  factory ConfigReader() => _instance;
  ConfigReader._();
  static final _instance = ConfigReader._();
  final Map<String, dynamic> _config = {};
  Future<void> initializeConfigReader() async {
    try {
      final configurationOpitons = await rootBundle.loadString('configs/emulator_config.json');
